...
class AppRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "base_url", "tools"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tools": [ToolRequest.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None
        })
        return _obj
