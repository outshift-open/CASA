...
class ActorClaim(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sub", "act"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"sub": obj.get("sub"), "act": ActorClaim.from_dict(obj["act"]) if obj.get("act") is not None else None}
        )
        return _obj


# TODO: Rewrite to not use raise_errors
ActorClaim.model_rebuild(raise_errors=False)
