...
class DefaultApi:
    ...
    @validate_call
    def get_traces_trace_get_with_http_info(
        self,
        page: Optional[Annotated[int, Field(strict=True, ge=1)]] = None,
        page_size: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_traces_trace_get_without_preload_content(
        self,
        page: Optional[Annotated[int, Field(strict=True, ge=1)]] = None,
        page_size: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        _request_timeout: Union[
    ...
    def _get_traces_trace_get_serialize(
        self,
        page,
        page_size,
        _request_auth,
    ...
    def trace_llm_call_end(
        self,
        llm_call_ended_request: LLMCallEndedRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._trace_llm_call_end_serialize(
            llm_call_ended_request=llm_call_ended_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def trace_llm_call_end_with_http_info(
        self,
        llm_call_ended_request: LLMCallEndedRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def trace_llm_call_end_without_preload_content(
        self,
        llm_call_ended_request: LLMCallEndedRequest,
        _request_timeout: Union[
            None,
    ...
    def _trace_llm_call_end_serialize(
        self,
        llm_call_ended_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if llm_call_ended_request is not None:
            _body_params = llm_call_ended_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/trace/llm/call_end',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def trace_llm_call_start(
        self,
        llm_call_started_request: LLMCallStartedRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._trace_llm_call_start_serialize(
            llm_call_started_request=llm_call_started_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def trace_llm_call_start_with_http_info(
        self,
        llm_call_started_request: LLMCallStartedRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def trace_llm_call_start_without_preload_content(
        self,
        llm_call_started_request: LLMCallStartedRequest,
        _request_timeout: Union[
            None,
    ...
    def _trace_llm_call_start_serialize(
        self,
        llm_call_started_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if llm_call_started_request is not None:
            _body_params = llm_call_started_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/trace/llm/call_start',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
