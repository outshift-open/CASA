...
CLIENT_APP_ID = os.getenv("TRUSTED_CLIENT_APP_ID", "")
CLIENT_ID = os.getenv("TRUSTED_CLIENT_ID", "")
CLIENT_SECRET = os.getenv("TRUSTED_CLIENT_SECRET", "")
...
async def process_chat(request: ChatRequest):
    ...
    with identity_auth_sdk.ApiClient(configuration) as api_client:
        ...
        try:
            client_token = api_instance.token(
            ...
            chat_response = await send_chat_request(user_content, client_token.access_token)
