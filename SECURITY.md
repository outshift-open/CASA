...
The `casa` maintainers take all security issues in the project
seriously. Thank you for improving the security of `casa`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`casa` leverages GitHub's private vulnerability reporting.
...
[casa-maintainers@outshift.com](mailto:casa-maintainers@outshift.com) contact email.
