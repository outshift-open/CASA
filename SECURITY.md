...
The `zta` maintainers take all security issues in the project
seriously. Thank you for improving the security of `zta`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`zta` leverages GitHub's private vulnerability reporting.
...
[zta-maintainers@outshift.com](mailto:zta-maintainers@outshift.com) contact email.
