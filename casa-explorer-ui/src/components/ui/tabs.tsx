...
const tabsListVariants = cva(
    'rounded-lg p-[3px] group-data-[orientation=horizontal]/tabs:h-9 data-[variant=line]:rounded-none group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col',
    {
        variants: {
            variant: {
                default: 'bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.07)]',
    ...
    return (
        <TabsPrimitive.Trigger
            ...
            className={cn(
                ...
                'data-[state=active]:bg-[rgba(255,255,255,0.10)] data-[state=active]:text-[rgba(255,255,255,0.94)] data-[state=active]:border-[rgba(255,255,255,0.12)]',
