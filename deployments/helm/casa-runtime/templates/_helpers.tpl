...
Usage: {{ include "casa-runtime.selectorLabels" (dict "Release" .Release "Chart" .Chart "component" "auth-service") }}
*/}}
{{- define "casa-runtime.selectorLabels" -}}
app.kubernetes.io/name: {{ .Chart.Name }}
app.kubernetes.io/instance: {{ .Release.Name }}
...
*/}}
{{- define "casa-runtime.postgresAuthHost" -}}
...
*/}}
{{- define "casa-runtime.postgresKeycloakHost" -}}
...
*/}}
{{- define "casa-runtime.keycloakUrl" -}}
...
*/}}
{{- define "casa-runtime.authServiceUrl" -}}
...
*/}}
{{- define "casa-runtime.keycloakEffectiveHostname" -}}
