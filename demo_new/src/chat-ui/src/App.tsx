          ...
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center py-16 text-center gap-6">
              ...
              <div className="flex flex-col gap-2">
                <h2 className="text-xl font-semibold text-foreground">Welcome to the <span className="text-safe">Banking Assistant</span></h2>
                <p className="text-sm text-slate-500 max-w-sm">
                  Your banking assistant. Every action is authorized by CASA to ensure it aligns with your intent.
                </p>
              </div>
              <div className="flex flex-col gap-2 w-full max-w-sm">
                <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Try asking</p>
                {[
                  'Get my bank summary for Acc#123456',
                  'Explain my unusual expenses',
