// Implementation taken from https://github.com/open-telemetry/opentelemetry-ebpf-instrumentation/blob/040eecc152e395759536a608aa134410d8862cfd/pkg/internal/helpers/container/container.go
package container
...
func InfoForPID(pid int32) (Info, error) {
	ns, err := FindNamespace(pid)
	if err != nil {
